...
playerCharacters.push(new playerCharacter(
    ...
    this.pcBio = "Mr Garrick, playwrite, thespian, gourmande. Garrick nevery spends a moment alone if he can help it, for introspection looms behind him like a spectre."
));
